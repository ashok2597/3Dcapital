...
add_action( 'widgets_init', 'capital_theme_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function capital_theme_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'capital_theme - Follow Us', 'capital_theme' ), // Name
                array('description' => __( 'Custom follow us widget', 'capital_theme' )) // Args
        );
    }
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'capital_theme' ); ?></label> 
