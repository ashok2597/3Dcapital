<?php
/**
 * 3D Capital: Color Patterns
 *
 * @package WordPress
 * @subpackage capital_theme
 * @since 1.0
 */
 ...
 */
function capital_theme_custom_colors_css() {
	...
	/**
	 * Filter 3D Capital default saturation level.
	 *
	 * @since 3D Capital 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */

	$saturation           = absint( apply_filters( 'capital_theme_custom_colors_saturation', 100 ) );
	$saturation           = $saturation . '%';

	$saturation_selection = absint( apply_filters( 'capital_theme_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	$lightness            = absint( apply_filters( 'capital_theme_custom_colors_lightness', 33 ) );
	$lightness            = $lightness . '%';

	$lightness_hover      = absint( apply_filters( 'capital_theme_custom_colors_lightness_hover', 23 ) );
	$lightness_hover      = $lightness_hover . '%';

	$lightness_selection  = absint( apply_filters( 'capital_theme_custom_colors_lightness_selection', 90 ) );
	...
	/**
	 * Filters 3D Capital custom colors CSS.
	 *
	 * @since 3D Capital 1.0
	 *
	 ...
	 */
	return apply_filters( 'capital_theme_custom_colors_css', $css, $primary_color, $saturation );
}
